...
#'
#' This data is from the Mayo Clinic trial in primary biliary cirrhosis (PBC) of
...
#' D-penicillamine, but only the first 312 cases in the data set participated in
#' the randomized trial. Therefore, the data here are for the 312 patients with
#' largely complete data.
#'
#' @usage data(pbc2)
...
#'   death, transplantion, or study analysis time.}
#'
