...
#'
#'   \item{\code{emergenc}}{operative urgency (\code{0=}elective,
#'   \code{1=}urgent, and \code{3=}emergency).}
#'
#'   \item{\code{hc}}{preoperative high cholesterol (\code{0=}absent,
#'   \code{1=}present treated, and \code{2=}present untreated).}
#'
